...
if __name__ == '__main__':
    ...
    training = PPOtraining(quad_env.QuadEnv, 2000000, np.array([0.45,0.65]), np.array([1.0,1.0]), 0.02, learningRate = wandb.config.learningRate, batchSize = wandb.config.batchSize, startDomain=np.array([0.55,0.55]), endDomain = np.array([0.49,0.61]), ADRMethod = 'loss', targetReliability=None, targetReward=None, initModelLoc=None, render = False, verbose = 1)
    #[0.10,0.10,0.2]
    #[0.02,0.05,0.2]
